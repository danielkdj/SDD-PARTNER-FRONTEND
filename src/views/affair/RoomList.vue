<template>
  ...
  <div class="mt-2 bg-white dark:bg-gray-800 p-5 w-full rounded-md box-border border dark:border-gray-700 h-screen">   <p class="font-bold text-base text-gray-800 dark:text-gray-200" id="title">회의실 신청내역</p>
    <div class="mt-2 flex items-center justify-end gap-x-6">
      <select v-model="category"
          ...
          <option value="12">A회의실</option>
          <option value="13">B회의실</option>
      </select>
      <select
              v-model="status"
              class="dark:bg-gray-800 dark:hover:bg-gray-700 border dark:border-gray-700 max-w-lg px-4 py-3 block rounded-md text-gray-500 dark:text-gray-400"
