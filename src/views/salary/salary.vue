      ...
      <div class="grid grid-cols-2 min-h-full">
        ...
        <div class="row-span-2 p-4 h-full">
          ...
          <div class="grid grid-cols-4 h-full text-center p-3">
            ...
            <div>연장수당 :</div>
            <div><input type="text" class="bg-gray-400 w-2/3 text-center" v-model="overtime"></div>
            <div>고용보험 :</div>
            <div><input type="text" class="bg-gray-400 w-2/3 text-center"
            ...
            <div>직책수당 :</div>
            <div><input type="text" class="bg-gray-400 w-2/3 text-center" v-model="positionAllowance"></div>
            <div>장기요양 :</div>
            <div><input type="text" class="bg-gray-400 w-2/3 text-center"
            ...
            <div>급여 소급분 :</div>
            <div><input type="text" class="bg-gray-400 w-2/3 text-center" v-model="extensionAllowance"></div>
            <div>지방소득세 :</div>
            <div><input type="text" class="bg-gray-400 w-2/3 text-center"
...
export default {
  ...
  watch: {
    ...
    computed: {
      eatfee() {
        return this.selectedUsers.eatfee || 0;
      },
      overtime() {
        return this.selectedUsers.overtime || 0;
      },
      positionAllowance() {
        return this.selectedUsers.positionAllowance || 0;
      },
      extensionAllowance() {
        return this.selectedUsers.extensionAllowance || 0;
      },
