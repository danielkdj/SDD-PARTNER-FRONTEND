            ...
            <div class="bg-white dark:bg-gray-900 w-full">
                <form>
                    ...
                    >
                        ...
                        <div class="space-y-3">
                            <h4 class="dark:text-white font-semibold text-gray-800 text-4xl">
                                비밀번호 변경
                            </h4>
                        </div>
                        ...
                        <div class="space-y-5">
                            <div class="flex justify-end gap-5">
                                <button class="text-white bg-primary hover:bg-primary/80 p-3 rounded-md">수정</button>
                                <button class="text-white bg-primary hover:bg-primary/80 p-3 rounded-md">취소</button>
                            </div>
                        </div>
